# crypto-validation-policy Specification

## Purpose

Clean-room cryptography policy: no C/C++ crypto libraries (cargo-deny enforced), every shipped primitive validated by official-corpus replay, with documented FIPS revisit triggers. See docs/crypto-validation.md.
